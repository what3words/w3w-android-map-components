...
interface W3WMapWrapper {
    ...
    /** Finds a marker on the map strictly by [coordinates].
     *
     * @param coordinates the latitude and longitude search query.
    ...
    /** Remove marker at [coordinates] from the map.
     *
     * @param coordinates of the marker to be removed.
     */
