...
interface W3WMap {
    ...
    /** Add marker at [W3WCoordinates] to the map. This method will add a marker/square to the map based on each of the coordinates provided latitude and longitude.
     *
     * @param coordinates coordinates to be added.
     * @param markerColor the [W3WMarkerColor] for the marker at [W3WCoordinates.lat], [W3WCoordinates.lng] added.
     * @param zoomOption the zoom option for this marker, by default will center and zoom, if not desired please use [W3WZoomOption.NONE] or [W3WZoomOption.CENTER]
    ...
    /** Set [W3WCoordinates] as selected marker on the map, it can only have one selected marker at the time.
     *
     * @param coordinates coordinates to be selected.
     * @param zoomOption the zoom option for these markers, by default will center and zoom to show all added, if not desired please use [W3WZoomOption.NONE]
    ...
    /** Remove marker at [W3WCoordinates] from the map.
     *
     * @param coordinates the [W3WCoordinates] to remove marker from.
     */
    fun removeMarkerAtCoordinates(coordinates: W3WCoordinates)
